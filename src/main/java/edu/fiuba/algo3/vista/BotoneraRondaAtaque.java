...
public class BotoneraRondaAtaque extends VBox{
    public BotoneraRondaAtaque(ContenedorPrincipal contenedor, Partida partida){
        ...
        String nombrePaisSeleccionado = listaPaisesEnControl.getSelectionModel().getSelectedItem();
        Pais paisSeleccionado = partida.obtenerUnPais(nombrePaisSeleccionado);
        ...
        for (Pais pais: partida.obtenerPaisesLimitrofesDe(paisSeleccionado, partida.obtenerJugadorActual())){
            String nombrePais = pais.obtenerNombrePais();
            String cantidadTropas = String.valueOf(pais.obtenerNumeroTotalDeTropas());
